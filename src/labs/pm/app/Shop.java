...
public class Shop {
	...
	public static void main(String[] args) {
		...
		pm.createProduct(104, "Cookie", BigDecimal.valueOf(3.99), Rating.NO_RATED, LocalDate.now());
		pm.reviewProduct(104, Rating.THREE_STAR, "Just another cookie");
		pm.reviewProduct(104, Rating.THREE_STAR, "Ok");
		pm.printProductReport(104);
		
		pm.createProduct(105, "Hot chocolate", BigDecimal.valueOf(3.99), Rating.NO_RATED);
		pm.reviewProduct(105, Rating.FOUR_STAR, "Tasty");
		pm.reviewProduct(105, Rating.FOUR_STAR, "Not bad at all");
		pm.printProductReport(105);
		
		pm.createProduct(106, "Cookie", BigDecimal.valueOf(3.99), Rating.NO_RATED, LocalDate.now().plusDays(3));
